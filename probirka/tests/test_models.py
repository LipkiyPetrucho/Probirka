...
class TestModelTests(TestCase):
    ...
    def setUpTestData(cls):
        cls.section = Section.objects.create(name='Гормоны',
                                             slug='gormony-model')  # уникально
        cls.subsection = Subsection.objects.create(name='Щитовидка',
                                                   section=cls.section)
        cls.service = AdditionalService.objects.create(name='Взятие крови',
                                                       price='130.00')
